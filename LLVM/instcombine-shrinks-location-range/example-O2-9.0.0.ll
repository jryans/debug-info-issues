...
attributes #3 = { nobuiltin nofree "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #6 = { noinline norecurse uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !1, producer: "clang version 9.0.0 (tags/RELEASE_900/final 372344)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !2, imports: !3, nameTableKind: None)
...
!11 = !DIFile(filename: "/opt/compiler-explorer/gcc-9.2.0/lib/gcc/x86_64-linux-gnu/9.2.0/../../../../include/c++/9.2.0/bits/std_abs.h", directory: "")
...
!15 = !DIFile(filename: "/opt/compiler-explorer/gcc-9.2.0/lib/gcc/x86_64-linux-gnu/9.2.0/../../../../include/c++/9.2.0/cstdlib", directory: "")
...
!58 = !DIFile(filename: "/opt/compiler-explorer/clang-9.0.0/lib/clang/9.0.0/include/stddef.h", directory: "")
...
!213 = !DIFile(filename: "/opt/compiler-explorer/gcc-9.2.0/lib/gcc/x86_64-linux-gnu/9.2.0/../../../../include/c++/9.2.0/stdlib.h", directory: "")
...
!221 = !DISubprogram(name: "abs", linkageName: "_ZSt3absg", scope: !5, file: !11, line: 103, type: !222, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
...
!252 = !{!"clang version 9.0.0 (tags/RELEASE_900/final 372344)"}
...
!258 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "trains", file: !254, line: 3, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !259, identifier: "_ZTS6trains")
...
!283 = !DILocation(line: 0, scope: !253)
...
!328 = !DILocation(line: 0, scope: !253, inlinedAt: !323)

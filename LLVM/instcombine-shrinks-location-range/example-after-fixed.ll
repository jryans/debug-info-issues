; ModuleID = '/app/example.ll' https://godbolt.org/z/8rbdG7zMr
...
entry:
  call void @llvm.dbg.value(metadata i64* %a, metadata !11, metadata !DIExpression(DW_OP_plus_uconst, 8, DW_OP_stack_value)), !dbg !12
  br label %sink1
...
entry:
  call void @llvm.dbg.value(metadata i64* undef, metadata !16, metadata !DIExpression()), !dbg !17
  br label %sink2

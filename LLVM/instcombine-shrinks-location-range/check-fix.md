...
Collected value for `h`
  ...
  Created deref expr (ReadLSB w32 (w32 0x0) a.deref)
...
Result: (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8)))
...
and
  ...
  i64* %a
  (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8)))
Query to parse
(query [] (Eq (w32 0x1BD370D6)
     (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8)))))
Parsed query
(Eq (w32 0x1BD370D6)
     (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8))))
...
and
  ...
  (w32 0x1BD370D6)
Query to parse
(query [] (Eq (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8)))
     (w32 0x1BD370D6)))
Parsed query
(Eq (Extract w32 0 (Add w64 (w64 0x977FECA2A8C97DE7) (w64 0x8)))
     (w32 0x1BD370D6))
...
Checking equivalence of `k` (decl src ln 2) from
  ...
  %gep = getelementptr i64, i64* %a, i64 %b
  (Extract w32 0 (Add w64 (w64 0x10F1B4690)
                         (Mul w64 (w64 0x8)
                                  (ReadLSB w64 (w32 0x0) b))))
and
  assn asm ln 20, prod ln 5.3, live ln 6, gen 0
  %gep = getelementptr i64, i64* %a, i64 %b
  (Extract w32 0 (Add w64 (w64 0x10F1B4660)
                         (Mul w64 (w64 0x8)
                                  (ReadLSB w64 (w32 0x0) b))))
Query to parse
array b[8] : w32 -> w8 = symbolic
array b[8] : w32 -> w8 = symbolic
(query [] (Eq (Extract w32 0 (Add w64 (w64 0x10F1B4690)
                             (Mul w64 (w64 0x8)
                                      (ReadLSB w64 (w32 0x0) b))))
     (Extract w32 0 (Add w64 (w64 0x10F1B4660)
                             (Mul w64 (w64 0x8)
                                      (ReadLSB w64 (w32 0x0) b))))))
Parsed query
(Eq (Extract w32 0 (Add w64 (w64 0x10F1B4690)
                             N0:(Mul w64 (w64 0x8)
                                         (ReadLSB w64 (w32 0x0) b))))
     (Extract w32 0 (Add w64 (w64 0x10F1B4660) N0)))
...
array b[8] : w32 -> w8 = symbolic
array b[8] : w32 -> w8 = symbolic
(query [] (Eq (Extract w32 0 (Add w64 (w64 0x10F1B4660)
                             (Mul w64 (w64 0x8)
                                      (ReadLSB w64 (w32 0x0) b))))
     (Extract w32 0 (Add w64 (w64 0x10F1B4690)
                             (Mul w64 (w64 0x8)
                                      (ReadLSB w64 (w32 0x0) b))))))
Parsed query
(Eq (Extract w32 0 (Add w64 (w64 0x10F1B4660)
                             N0:(Mul w64 (w64 0x8)
                                         (ReadLSB w64 (w32 0x0) b))))
     (Extract w32 0 (Add w64 (w64 0x10F1B4690) N0)))

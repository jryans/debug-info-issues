...
Computing generations: `a` (decl src ln 7)
  asm ln 24, prod ln 7.16, live ln 13, gen 0
  asm ln 27, prod ln 13.7, live ln 14, gen 1
  asm ln 29, prod ln 14.7, live ln 15, gen 2
  asm ln 34, prod ln 14.7, live ln 19, gen 3
...
Checking equivalence of `a` (decl src ln 7) from
  assn asm ln 34, prod ln 14.7, live ln 19, gen 3
  %a.0 = phi i32 [ %div, %if.then ], [ 0, %entry ]
  (w32 0x0)
and
  assn asm ln 29, prod ln 14.7, live ln 15, gen 2
  %div = sdiv i32 %mul, 3, l14 c7
  (SDiv w32 (Add w32 (w32 0xF0)
                    (Mul w32 (w32 0x14)
                             (ReadLSB w32 (w32 0x0) foo_2)))
  ...
  (Mul w32 (w32 0x14)
          (Add w32 (w32 0xC)
                   (Sub w32 (Add w32 N0:(Add w32 (ReadLSB w32 (w32 0x0) foo)
                            ...
                            N0)))
and
  assn asm ln 27, prod ln 13.7, live ln 14, gen 1
  %mul = add i32 %0, 240, l13 c7
  (Add w32 (w32 0xF0)
          (Mul w32 (w32 0x14)
                   (ReadLSB w32 (w32 0x0) foo_2)))
...
(Eq (w32 0x0)
     (SDiv w32 (Add w32 (w32 0xF0)
                        (Mul w32 (w32 0x14)
                                 (ReadLSB w32 (w32 0x0) foo_2)))
               (w32 0x3)))
❌ After `a` (decl src ln 7) assn asm ln 29, prod ln 14.7, live ln 15, gen 2 symbolic value doesn't match before assn asm ln 59, prod ln 16.7, live ln 17, gen 5
...
🔔 Before `a` (decl src ln 7) assn asm ln 35, prod ln 8.5, live ln 10, gen 1 coordinates don't match after assn asm ln 24, prod ln 7.16, live ln 13, gen 0
Checking equivalence of `a` (decl src ln 7) from
  assn asm ln 24, prod ln 7.16, live ln 13, gen 0
  %foo.0.foo.0.16 = load volatile i32, i32* %foo, !tbaa !20, l6 c16
  (Add w32 (ReadLSB w32 (w32 0x0) foo_2)
...
(Eq (Add w32 N0:(ReadLSB w32 (w32 0x0) foo_2)
     ...
     (Add w32 (Add w32 (ReadLSB w32 (w32 0x0) foo)
                       (ReadLSB w32 (w32 0x0) foo_1))
              N0))
❌ Before `a` (decl src ln 7) assn asm ln 35, prod ln 8.5, live ln 10, gen 1 symbolic value doesn't match after assn asm ln 24, prod ln 7.16, live ln 13, gen 0

🔔 Before `a` (decl src ln 7) assn asm ln 49, prod ln 12.7, live ln 13, gen 2 coordinates don't match after assn asm ln 27, prod ln 13.7, live ln 14, gen 1
Checking equivalence of `a` (decl src ln 7) from
  assn asm ln 27, prod ln 13.7, live ln 14, gen 1
  %mul = add i32 %0, 240, l13 c7
  (Add w32 (w32 0xF0)
...
(Eq (Add w32 (w32 0xF0)
     ...
     (Add w32 (w32 0xC)
              (Sub w32 (Add w32 N1:(Add w32 (ReadLSB w32 (w32 0x0) foo)
                                ...
                                N0)
                       N1)))
❌ Before `a` (decl src ln 7) assn asm ln 49, prod ln 12.7, live ln 13, gen 2 symbolic value doesn't match after assn asm ln 27, prod ln 13.7, live ln 14, gen 1

🔔 Before `a` (decl src ln 7) assn asm ln 52, prod ln 13.7, live ln 14, gen 3 coordinates don't match after assn asm ln 29, prod ln 14.7, live ln 15, gen 2
Checking equivalence of `a` (decl src ln 7) from
  assn asm ln 29, prod ln 14.7, live ln 15, gen 2
  %div = sdiv i32 %mul, 3, l14 c7
  (SDiv w32 (Add w32 (w32 0xF0)
     ...
     (Mul w32 (w32 0x14)
              (Add w32 (w32 0xC)
                       (Sub w32 (Add w32 N1:(Add w32 (ReadLSB w32 (w32 0x0) foo)
                                         ...
                                         N0)
                                N1))))
❌ Before `a` (decl src ln 7) assn asm ln 52, prod ln 13.7, live ln 14, gen 3 symbolic value doesn't match after assn asm ln 29, prod ln 14.7, live ln 15, gen 2

🔔 Before `a` (decl src ln 7) assn asm ln 59, prod ln 16.7, live ln 17, gen 5 coordinates don't match after assn asm ln 34, prod ln 14.7, live ln 19, gen 3
Checking equivalence of `a` (decl src ln 7) from
  assn asm ln 34, prod ln 14.7, live ln 19, gen 3
  %a.0 = phi i32 [ %div, %if.then ], [ 0, %entry ]
  (w32 0x0)

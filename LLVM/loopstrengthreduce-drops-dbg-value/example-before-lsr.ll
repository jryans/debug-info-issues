...
for.cond:                                         ; preds = %for.body
  %inc = add nuw nsw i32 %current.06, 1, !dbg !23
  call void @llvm.dbg.value(metadata i32 %inc, metadata !14, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.value(metadata i32 %current.06, metadata !14, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !15
  %cmp = icmp slt i32 %current.06, %0, !dbg !24
  br i1 %cmp, label %for.body, label %cleanup, !dbg !22, !llvm.loop !25

for.body:                                         ; preds = %entry, %for.cond
  %current.06 = phi i32 [ %input, %entry ], [ %inc, %for.cond ]
  call void @llvm.dbg.value(metadata i32 %current.06, metadata !14, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.value(metadata i32 %current.06, metadata !14, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !15
...
!23 = !DILocation(line: 3, column: 47, scope: !19)
!24 = !DILocation(line: 3, column: 33, scope: !19)

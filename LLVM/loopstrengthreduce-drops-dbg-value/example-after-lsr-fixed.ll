...
entry:
  ...
  %cmp1 = icmp slt i32 %input, 3
  %0 = add nuw nsw i32 %input, 9
  %1 = add i32 %input, -1, !dbg !16
...
for.cond:                                         ; preds = %for.body
  ...
  %cmp = icmp slt i32 %lsr.iv.next, %0, !dbg !18
...
for.body:                                         ; preds = %entry, %for.cond
  ...
  call void @llvm.dbg.value(metadata i32 %lsr.iv, metadata !14, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !15
  br i1 %cmp1, label %cleanup, label %for.cond, !dbg !23
...
!18 = !DILocation(line: 3, column: 33, scope: !19)
...
!24 = distinct !DILexicalBlock(scope: !19, file: !8, line: 3, column: 58)

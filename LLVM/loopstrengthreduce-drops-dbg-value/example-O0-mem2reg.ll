...
entry:
  call void @llvm.dbg.value(metadata i32 %blah, metadata !11, metadata !DIExpression()), !dbg !12
  call void @llvm.dbg.value(metadata i32 %blah, metadata !13, metadata !DIExpression()), !dbg !12
  br label %for.cond, !dbg !14

for.cond:                                         ; preds = %for.inc, %entry
  %bob.0 = phi i32 [ %blah, %entry ], [ %inc, %for.inc ], !dbg !16
  call void @llvm.dbg.value(metadata i32 %bob.0, metadata !13, metadata !DIExpression()), !dbg !12
  %add = add nsw i32 %blah, 10, !dbg !17
  %cmp = icmp slt i32 %bob.0, %add, !dbg !19
  br i1 %cmp, label %for.body, label %for.end, !dbg !20

for.body:                                         ; preds = %for.cond
  %cmp1 = icmp slt i32 %bob.0, 3, !dbg !21
...
for.inc:                                          ; preds = %if.end
  %inc = add nsw i32 %bob.0, 1, !dbg !27
...
!11 = !DILocalVariable(name: "blah", arg: 1, scope: !7, file: !1, line: 1, type: !10)
!12 = !DILocation(line: 0, scope: !7)
!13 = !DILocalVariable(name: "bob", scope: !7, file: !1, line: 2, type: !10)

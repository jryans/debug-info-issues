...
entry:
  ...
  %add = add i8 %conv, 71
  %cmp27113 = icmp slt i8 %add, 10
  call void @llvm.dbg.value(metadata i8 %sub, metadata !52, metadata !DIExpression()), !dbg !70
  %conv3115 = zext i8 %sub to i32, !dbg !71
  %cmp20116 = icmp sgt i32 %sub19, %conv3115, !dbg !72
  br i1 %cmp20116, label %for.body, label %for.cond.cleanup, !dbg !73
...
for.body:                                         ; preds = %entry, %for.cond.cleanup29
  %conv3118 = phi i32 [ %conv3, %for.cond.cleanup29 ], [ %conv3115, %entry ]
  %i_0.0117 = phi i8 [ %add76, %for.cond.cleanup29 ], [ %sub, %entry ]
  call void @llvm.dbg.value(metadata i8 %i_0.0117, metadata !52, metadata !DIExpression()), !dbg !70
  call void @llvm.dbg.value(metadata i8 %add, metadata !58, metadata !DIExpression()), !dbg !83
  %idxprom = zext i8 %i_0.0117 to i64
  %sub36 = add nsw i32 %conv3118, -1
  %idxprom37 = sext i32 %sub36 to i64
  %arrayidx67 = getelementptr inbounds i16, i16* %arr_0, i64 %idxprom
  call void @llvm.dbg.value(metadata i8 %add, metadata !58, metadata !DIExpression()), !dbg !83
  br i1 %cmp27113, label %for.body30, label %for.cond.cleanup29, !dbg !84

for.cond.cleanup29:                               ; preds = %for.body30, %for.body
  %add76 = add i8 %i_0.0117, 4, !dbg !85
...
for.body30:                                       ; preds = %for.body, %for.body30
  %i_1.0114 = phi i8 [ %add72, %for.body30 ], [ %add, %for.body ]
  ...
  %1 = load i64, i64* %arrayidx33, align 8, !dbg !90, !tbaa !78
  call void @llvm.dbg.value(metadata i64 %1, metadata !61, metadata !DIExpression()), !dbg !91
  %arrayidx40 = getelementptr inbounds [10 x i64], [10 x i64]* %arr_4, i64 %idxprom37, i64 %idxprom32, !dbg !90
  %2 = load i64, i64* %arrayidx40, align 8, !dbg !90, !tbaa !78
  call void @llvm.dbg.value(metadata i64 %2, metadata !66, metadata !DIExpression()), !dbg !91
  %cmp42 = icmp ult i64 %1, %2, !dbg !90
  %cond47 = select i1 %cmp42, i64 %1, i64 %2, !dbg !90
  %3 = trunc i64 %cond47 to i16, !dbg !92
  %conv48 = xor i16 %3, -1, !dbg !92
  ...
  %4 = load i64, i64* %arrayidx33, align 8, !dbg !100, !tbaa !78
  %conv61 = trunc i64 %4 to i8, !dbg !101
  ...
  %5 = load i16, i16* %arrayidx67, align 2, !dbg !104, !tbaa !95
  %sext = trunc i16 %5 to i8, !dbg !105

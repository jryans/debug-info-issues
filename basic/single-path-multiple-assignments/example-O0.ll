...
entry:
  ...
  %4 = load i32, i32* %n.addr, align 4, !dbg !28
  %add2 = add nsw i32 %3, %4, !dbg !29
  store i32 %add2, i32* %x, align 4, !dbg !30
  %5 = load i32, i32* %x, align 4, !dbg !31
  %mul3 = mul nsw i32 %5, 2, !dbg !32
  store i32 %mul3, i32* %y, align 4, !dbg !33
...
!28 = !DILocation(line: 4, column: 11, scope: !11)
!29 = !DILocation(line: 4, column: 9, scope: !11)
!30 = !DILocation(line: 4, column: 5, scope: !11)
!31 = !DILocation(line: 5, column: 7, scope: !11)
!32 = !DILocation(line: 5, column: 9, scope: !11)
!33 = !DILocation(line: 5, column: 5, scope: !11)
!34 = !DILocation(line: 6, column: 10, scope: !11)

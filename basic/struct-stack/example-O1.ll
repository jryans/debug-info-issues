...
entry:
  ...
  call void @llvm.dbg.value(metadata i32 %n, metadata !17, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value, DW_OP_LLVM_fragment, 32, 32)), !dbg !22
  %reass.add = shl i32 %n, 1, !dbg !23
  %add3 = or i32 %reass.add, 1, !dbg !23
  ret i32 %add3, !dbg !24
}
...
!11 = distinct !DISubprogram(name: "example", scope: !8, file: !8, line: 6, type: !12, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !7, retainedNodes: !15)
...
!23 = !DILocation(line: 9, column: 14, scope: !11)
!24 = !DILocation(line: 9, column: 3, scope: !11)

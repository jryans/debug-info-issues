...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %cmp17, label %for.body.preheader, label %cleanup, !dbg !37
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  call void @llvm.dbg.value(metadata i32 %1, metadata !20, metadata !DIExpression()), !dbg !24
  %exitcond.not = icmp eq i32 %1, %inc, !dbg !35
...
cleanup:                                          ; preds = %for.body, %for.cond.preheader, %entry
  ...
  %2 = bitcast i32* %t to i8*, !dbg !25
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #4, !dbg !45

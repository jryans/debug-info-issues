...
entry:
  ...
  %id17 = bitcast %struct.S* %s to i32*, !dbg !26
  store i32 %n, i32* %id17, align 8, !dbg !26, !tbaa !27
...
if.then:                                          ; preds = %land.lhs.true
  %id718 = bitcast %struct.S* %2 to i32*, !dbg !42
  %3 = load i32, i32* %id718, align 8, !dbg !42, !tbaa !27
  br label %cleanup, !dbg !43

if.end:                                           ; preds = %land.lhs.true
  %4 = icmp eq %struct.S* %1, null, !dbg !37
  br i1 %4, label %if.end13, label %if.then10, !dbg !44

if.then10:                                        ; preds = %if.end
  %id1219 = bitcast %struct.S* %1 to i32*, !dbg !45
  %5 = load i32, i32* %id1219, align 8, !dbg !45, !tbaa !27
  br label %cleanup, !dbg !47

if.end13:                                         ; preds = %entry, %if.end
  %6 = bitcast %struct.S* %s to i32*, !dbg !26
  %7 = load i32, i32* %6, align 8, !dbg !48, !tbaa !27
  br label %cleanup, !dbg !49

cleanup:                                          ; preds = %if.end13, %if.then10, %if.then
  %retval.0 = phi i32 [ %3, %if.then ], [ %5, %if.then10 ], [ %7, %if.end13 ], !dbg !23
  %8 = bitcast %struct.S* %s to i8*, !dbg !24
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %8) #5, !dbg !50

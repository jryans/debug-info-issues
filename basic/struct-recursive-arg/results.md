...
Checking equivalence of `s` (decl src ln 10) from
  assn asm ln 16, prod ln 10.16, live ln 11, enc 0
  i32 %n
and
  assn asm ln 46, prod ln 16.12, live ln 17, enc None
  %7 = load i32, i32* %6, !tbaa !27, l16 c12
...
Collating encountered after assignments: `s` (decl src ln 10)
❌ Assignment asm ln 46, prod ln 16.12, live ln 17, enc None for `s` (decl src ln 10) was not encountered during execution
  asm ln 16, prod ln 10.16, live ln 11, enc 0
...
❌ After assn asm ln 46, prod ln 16.12, live ln 17, enc None for `s` (decl src ln 10) was not encountered during execution

❌ After encountered assn for `s` (decl src ln 10) at asm ln 16, prod ln 10.16, live ln 11, enc 0 not found in before
...
Availability Errors:
  ...
  Test Not Encount.:         1 ( 33.33% of test)

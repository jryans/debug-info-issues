...
while.body:                                       ; preds = %while.body.preheader, %while.body
  ...
  %mul = shl nsw i32 %0, 2, !dbg !24
  %add = add nsw i32 %mul, %n, !dbg !25
  call void @llvm.dbg.value(metadata i32 %add, metadata !19, metadata !DIExpression()), !dbg !26
  %arrayidx = getelementptr inbounds i32, i32* %data, i64 %indvars.iv, !dbg !27
  store i32 %add, i32* %arrayidx, align 4, !dbg !28, !tbaa !29
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !22
  br i1 %exitcond.not, label %while.end.loopexit, label %while.body, !dbg !23, !llvm.loop !34
...
!24 = !DILocation(line: 6, column: 19, scope: !20)
!25 = !DILocation(line: 6, column: 24, scope: !20)
!26 = !DILocation(line: 0, scope: !20)
!27 = !DILocation(line: 7, column: 5, scope: !20)
!28 = !DILocation(line: 7, column: 13, scope: !20)
!29 = !{!30, !30, i64 0}
!30 = !{!"int", !31, i64 0}
!31 = !{!"omnipotent char", !32, i64 0}
!32 = !{!"Simple C/C++ TBAA"}
!33 = !DILocation(line: 8, column: 7, scope: !20)
!34 = distinct !{!34, !23, !35, !36, !37, !38}
!35 = !DILocation(line: 9, column: 3, scope: !8)
!36 = !{!"llvm.loop.mustprogress"}
!37 = !{!"llvm.loop.unroll.disable"}
!38 = !{!"llvm.loop.vectorize.width", i32 1}
!39 = !DILocation(line: 10, column: 1, scope: !8)

...
entry:
  %0 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !dbg !14
  %call = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0)), !dbg !15
  ret void, !dbg !16
}

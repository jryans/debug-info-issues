...
Load from declared address of `argc` (decl src ln 6), asm ln 18
  %0 = load i32, i32* %argc.addr, l8 c7, asm ln 18
  🔔 Live ln too early, using produced ln + 1
  Added assignment asm ln 18, prod ln 8.7, live ln 9, enc None
Store to declared address of `argc` (decl src ln 6), asm ln 14
  arg 0
  Added assignment asm ln 14, prod ln 6.0, live ln 8, enc None
Load from declared address of `argv` (decl src ln 6), asm ln 23
  %1 = load i8**, i8*** %argv.addr, l8 c27, asm ln 23
  🔔 Live ln too early, using produced ln + 1
  Added assignment asm ln 23, prod ln 8.27, live ln 9, enc None
Store to declared address of `argv` (decl src ln 6), asm ln 16
  arg 1
  Added assignment asm ln 16, prod ln 6.0, live ln 8, enc None

#### After variables

Value produced for `argc` (decl src ln 6), asm ln 11
  arg 0
  Added assignment asm ln 11, prod ln 6.0, live ln 8, enc None
Value produced for `argv` (decl src ln 6), asm ln 12
  arg 1
  Added assignment asm ln 12, prod ln 6.0, live ln 8, enc None
...
Collected value for `argc`
  Assignment asm ln 14, prod ln 6.0, live ln 8, enc 0
  i32 %argc
  (ReadLSB w32 (w32 0x0) argc)
Collected value for `argv`
  Assignment asm ln 16, prod ln 6.0, live ln 8, enc 0
...
Collected value for `argc`
  Assignment asm ln 18, prod ln 8.7, live ln 9, enc 1
  %0 = load i32, i32* %argc.addr, l8 c7
  (ReadLSB w32 (w32 0x0) argc)
Collected value for `argv`
  Assignment asm ln 23, prod ln 8.27, live ln 9, enc 1
  Concrete pointer resolves to argv.deref, offset (w64 0x0)
  Created deref expr <concrete pointer>
  Replaced concrete pointer with hash (w64 0x339B17540BD60D2)

...
for.body:                                         ; preds = %entry, %for.body
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !93, metadata !DIExpression()), !dbg !99
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* @g_20, i64 0, i64 %indvars.iv, !dbg !114
  %1 = load i32, i32* %arrayidx, align 4, !dbg !114, !tbaa !108
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next, metadata !93, metadata !DIExpression()), !dbg !99
  %exitcond.not = icmp eq i64 %indvars.iv.next, 4, !dbg !119
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !112, !llvm.loop !120

for.end:                                          ; preds = %for.body
  store volatile i64 -1263720131, i64* @csmith_sink_, align 8, !dbg !124, !tbaa !103
  store volatile i64 4, i64* @csmith_sink_, align 8, !dbg !125, !tbaa !103
  store volatile i64 1031534065, i64* @csmith_sink_, align 8, !dbg !126, !tbaa !103
  %bf.load = load i56, i56* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46 to i56*), align 8, !dbg !127
  %bf.shl = shl i56 %bf.load, 43, !dbg !127
  %bf.ashr = ashr exact i56 %bf.shl, 43, !dbg !127
  %bf.cast = zext i56 %bf.ashr to i64, !dbg !127
  %sext = shl i64 %bf.cast, 32, !dbg !128
  %conv6 = ashr exact i64 %sext, 32, !dbg !128
  store volatile i64 %conv6, i64* @csmith_sink_, align 8, !dbg !129, !tbaa !103
  %bf.load7 = load volatile i56, i56* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46 to i56*), align 8, !dbg !130
  %bf.lshr = lshr i56 %bf.load7, 13, !dbg !130
  %2 = and i56 %bf.lshr, 16383, !dbg !130
  %bf.cast8 = zext i56 %2 to i64, !dbg !130
  store volatile i64 %bf.cast8, i64* @csmith_sink_, align 8, !dbg !131, !tbaa !103
  %bf.shl11 = shl i56 %bf.load7, 5, !dbg !132
  %bf.ashr12 = ashr i56 %bf.shl11, 32, !dbg !132
  %bf.cast13 = zext i56 %bf.ashr12 to i64, !dbg !132
  %sext44 = shl i64 %bf.cast13, 32, !dbg !133
  %conv14 = ashr exact i64 %sext44, 32, !dbg !133
  store volatile i64 %conv14, i64* @csmith_sink_, align 8, !dbg !134, !tbaa !103
  %3 = load i8, i8* getelementptr inbounds ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }, { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46, i64 0, i32 7), align 1, !dbg !135, !tbaa !136
  %conv15 = sext i8 %3 to i64, !dbg !138
  store volatile i64 %conv15, i64* @csmith_sink_, align 8, !dbg !139, !tbaa !103
  %bf.load16 = load i24, i24* bitcast (i8* getelementptr inbounds ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }, { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46, i64 0, i32 8) to i24*), align 8, !dbg !140
  %bf.clear17 = and i24 %bf.load16, 7, !dbg !140
  %conv19 = zext i24 %bf.clear17 to i64, !dbg !141
  store volatile i64 %conv19, i64* @csmith_sink_, align 8, !dbg !142, !tbaa !103
  %bf.load20 = load volatile i24, i24* bitcast (i8* getelementptr inbounds ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }, { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46, i64 0, i32 8) to i24*), align 8, !dbg !143
  %bf.shl21 = shl i24 %bf.load20, 7, !dbg !143
  %bf.ashr22 = ashr i24 %bf.shl21, 10, !dbg !143
  %conv24 = sext i24 %bf.ashr22 to i64, !dbg !144
  store volatile i64 %conv24, i64* @csmith_sink_, align 8, !dbg !145, !tbaa !103
  call void @llvm.dbg.value(metadata i32 0, metadata !93, metadata !DIExpression()), !dbg !99
  br label %for.body28, !dbg !146

for.body28:                                       ; preds = %for.end, %for.body28
  %indvars.iv47 = phi i64 [ 0, %for.end ], [ %indvars.iv.next48, %for.body28 ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv47, metadata !93, metadata !DIExpression()), !dbg !99
  %arrayidx30 = getelementptr inbounds [6 x i32], [6 x i32]* @g_48, i64 0, i64 %indvars.iv47, !dbg !148
  %4 = load i32, i32* %arrayidx30, align 4, !dbg !148, !tbaa !108
  %conv31 = sext i32 %4 to i64, !dbg !148
  store volatile i64 %conv31, i64* @csmith_sink_, align 8, !dbg !151, !tbaa !103
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1, !dbg !152
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next48, metadata !93, metadata !DIExpression()), !dbg !99
  %exitcond49.not = icmp eq i64 %indvars.iv.next48, 6, !dbg !153
  br i1 %exitcond49.not, label %for.end34, label %for.body28, !dbg !146, !llvm.loop !154
...
; Function Attrs: nofree noinline norecurse nounwind ssp uwtable
define internal fastcc void @func_1() unnamed_addr #0 !dbg !157 {
entry:
  call void @llvm.dbg.declare(metadata [374 x i8]* undef, metadata !161, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 2992)), !dbg !187
  call void @llvm.dbg.declare(metadata [104 x i8]* undef, metadata !161, metadata !DIExpression(DW_OP_LLVM_fragment, 3008, 832)), !dbg !187
  call void @llvm.dbg.value(metadata i16 -20131, metadata !161, metadata !DIExpression(DW_OP_LLVM_fragment, 2992, 16)), !dbg !188
  call void @llvm.dbg.value(metadata i32* undef, metadata !166, metadata !DIExpression()), !dbg !188
  call void @llvm.dbg.value(metadata i32 -181181382, metadata !173, metadata !DIExpression()), !dbg !188
  call void @llvm.dbg.declare(metadata i32* undef, metadata !174, metadata !DIExpression()), !dbg !189
  call void @llvm.dbg.declare(metadata i32* undef, metadata !175, metadata !DIExpression()), !dbg !190
  call void @llvm.dbg.declare(metadata i32* undef, metadata !176, metadata !DIExpression()), !dbg !191
  store i1 true, i1* @g_2, align 4, !dbg !192
  call void @llvm.dbg.value(metadata i32 -181181382, metadata !173, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !188
  %bf.load = load volatile i24, i24* bitcast (i8* getelementptr inbounds ({ i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }, { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_46, i64 0, i32 8) to i24*), align 8, !dbg !193
  ret void, !dbg !194
}
...
!118 = !DILocation(line: 127, column: 25, scope: !116)
!119 = !DILocation(line: 127, column: 19, scope: !116)
!120 = distinct !{!120, !112, !121, !122, !123}
!121 = !DILocation(line: 130, column: 5, scope: !113)
!122 = !{!"llvm.loop.mustprogress"}
!123 = !{!"llvm.loop.unroll.disable"}
!124 = !DILocation(line: 131, column: 18, scope: !89)
!125 = !DILocation(line: 132, column: 18, scope: !89)
!126 = !DILocation(line: 133, column: 18, scope: !89)
!127 = !DILocation(line: 134, column: 25, scope: !89)
!128 = !DILocation(line: 134, column: 20, scope: !89)
!129 = !DILocation(line: 134, column: 18, scope: !89)
!130 = !DILocation(line: 135, column: 25, scope: !89)
!131 = !DILocation(line: 135, column: 18, scope: !89)
!132 = !DILocation(line: 136, column: 25, scope: !89)
!133 = !DILocation(line: 136, column: 20, scope: !89)
!134 = !DILocation(line: 136, column: 18, scope: !89)
!135 = !DILocation(line: 137, column: 25, scope: !89)
!136 = !{!137, !105, i64 7}
!137 = !{!"S0", !109, i64 0, !109, i64 1, !109, i64 3, !105, i64 7, !109, i64 8, !109, i64 8}
!138 = !DILocation(line: 137, column: 20, scope: !89)
!139 = !DILocation(line: 137, column: 18, scope: !89)
!140 = !DILocation(line: 138, column: 25, scope: !89)
!141 = !DILocation(line: 138, column: 20, scope: !89)
!142 = !DILocation(line: 138, column: 18, scope: !89)
!143 = !DILocation(line: 139, column: 25, scope: !89)
!144 = !DILocation(line: 139, column: 20, scope: !89)
!145 = !DILocation(line: 139, column: 18, scope: !89)
!146 = !DILocation(line: 140, column: 5, scope: !147)
!147 = distinct !DILexicalBlock(scope: !89, file: !3, line: 140, column: 5)
!148 = !DILocation(line: 142, column: 24, scope: !149)
!149 = distinct !DILexicalBlock(scope: !150, file: !3, line: 141, column: 5)
!150 = distinct !DILexicalBlock(scope: !147, file: !3, line: 140, column: 5)
!151 = !DILocation(line: 142, column: 22, scope: !149)
!152 = !DILocation(line: 140, column: 25, scope: !150)
!153 = !DILocation(line: 140, column: 19, scope: !150)
!154 = distinct !{!154, !146, !155, !122, !123}
!155 = !DILocation(line: 143, column: 5, scope: !147)
!156 = !DILocation(line: 145, column: 5, scope: !89)
!157 = distinct !DISubprogram(name: "func_1", scope: !3, file: !3, line: 58, type: !158, scopeLine: 59, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !160)
!158 = !DISubroutineType(types: !159)
!159 = !{!77}
!160 = !{!161, !166, !167, !173, !174, !175, !176, !177, !182, !183}
!161 = !DILocalVariable(name: "l_5", scope: !157, file: !3, line: 60, type: !162)
!162 = !DICompositeType(tag: DW_TAG_array_type, baseType: !15, size: 3840, elements: !163)
!163 = !{!164, !75, !165}
!164 = !DISubrange(count: 5)
!165 = !DISubrange(count: 8)
!166 = !DILocalVariable(name: "l_54", scope: !157, file: !3, line: 61, type: !32)
!167 = !DILocalVariable(name: "l_55", scope: !157, file: !3, line: 62, type: !168)
!168 = !DICompositeType(tag: DW_TAG_array_type, baseType: !32, size: 4480, elements: !169)
!169 = !{!170, !171, !172}
!170 = !DISubrange(count: 7)
!171 = !DISubrange(count: 1)
!172 = !DISubrange(count: 10)
!173 = !DILocalVariable(name: "l_56", scope: !157, file: !3, line: 63, type: !12)
!174 = !DILocalVariable(name: "i", scope: !157, file: !3, line: 64, type: !27)
!175 = !DILocalVariable(name: "j", scope: !157, file: !3, line: 64, type: !27)
!176 = !DILocalVariable(name: "k", scope: !157, file: !3, line: 64, type: !27)
!177 = !DILocalVariable(name: "l_51", scope: !178, file: !3, line: 67, type: !181)
!178 = distinct !DILexicalBlock(scope: !179, file: !3, line: 66, column: 5)
!179 = distinct !DILexicalBlock(scope: !180, file: !3, line: 65, column: 5)
!180 = distinct !DILexicalBlock(scope: !157, file: !3, line: 65, column: 5)
!181 = !DICompositeType(tag: DW_TAG_array_type, baseType: !9, size: 64, elements: !53)
!182 = !DILocalVariable(name: "i", scope: !178, file: !3, line: 68, type: !27)
!183 = !DILocalVariable(name: "l_14", scope: !184, file: !3, line: 71, type: !9)
!184 = distinct !DILexicalBlock(scope: !185, file: !3, line: 70, column: 9)
!185 = distinct !DILexicalBlock(scope: !186, file: !3, line: 69, column: 9)
!186 = distinct !DILexicalBlock(scope: !178, file: !3, line: 69, column: 9)
!187 = !DILocation(line: 60, column: 13, scope: !157)
!188 = !DILocation(line: 0, scope: !157)
!189 = !DILocation(line: 64, column: 9, scope: !157)
!190 = !DILocation(line: 64, column: 12, scope: !157)
!191 = !DILocation(line: 64, column: 15, scope: !157)
!192 = !DILocation(line: 0, scope: !180)
!193 = !DILocation(line: 77, column: 17, scope: !157)
!194 = !DILocation(line: 77, column: 5, scope: !157)

...
for.cond2.preheader:                              ; preds = %entry, %for.inc18
  %lsr.iv = phi [8 x [6 x [1 x i32]]]* [ @g_20, %entry ], [ %3, %for.inc18 ]
...
for.body9:                                        ; preds = %for.cond2.preheader, %for.body9
  ...
  %scevgep63 = getelementptr [8 x [6 x [1 x i32]]], [8 x [6 x [1 x i32]]]* %lsr.iv, i64 0, i64 0, i64 %indvars.iv, i64 0, !dbg !108
  %2 = load i32, i32* %scevgep63, align 4, !dbg !108, !tbaa !99
...
for.inc18:                                        ; preds = %for.body9
  ...
  %scevgep = getelementptr [8 x [6 x [1 x i32]]], [8 x [6 x [1 x i32]]]* %lsr.iv, i64 0, i64 1, i64 0, i64 0, !dbg !102
  %3 = bitcast i32* %scevgep to [8 x [6 x [1 x i32]]]*, !dbg !102
...
for.end20:                                        ; preds = %for.inc18
  ...
  %4 = load volatile i32, i32* @g_22, align 4, !dbg !126, !tbaa !99
  %conv22 = zext i32 %4 to i64, !dbg !126
  store volatile i64 %conv22, i64* @csmith_sink_, align 8, !dbg !127, !tbaa !94
  %5 = load volatile i16, i16* getelementptr inbounds (%struct.S0, %struct.S0* @g_25, i64 0, i32 0), align 2, !dbg !128, !tbaa !129
  %conv23 = sext i16 %5 to i64, !dbg !132
  store volatile i64 %conv23, i64* @csmith_sink_, align 8, !dbg !133, !tbaa !94
  %6 = load volatile i8, i8* getelementptr inbounds (%struct.S0, %struct.S0* @g_25, i64 0, i32 1), align 2, !dbg !134, !tbaa !135
  %conv24 = zext i8 %6 to i64, !dbg !136
  store volatile i64 %conv24, i64* @csmith_sink_, align 8, !dbg !137, !tbaa !94
  %7 = load volatile i16, i16* @g_35, align 2, !dbg !138, !tbaa !139
  %conv25 = sext i16 %7 to i64, !dbg !138
  ...
  %8 = load volatile i16, i16* getelementptr inbounds ([1 x i16], [1 x i16]* @g_37, i64 0, i64 0), align 2, !dbg !141, !tbaa !139
  %conv32 = zext i16 %8 to i64, !dbg !141

...
lor.end:                                          ; preds = %lor.rhs, %for.end38
  %6 = xor i1 %tobool39.not, true, !dbg !132
  %lor.ext = zext i1 %6 to i32, !dbg !132
  %7 = load i32*, i32** @g_34, align 8, !dbg !134, !tbaa !118
  store i32 %lor.ext, i32* %7, align 4, !dbg !135, !tbaa !95
  ret i8 79, !dbg !136
}

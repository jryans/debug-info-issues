...
entry:
  ...
  %.off = add i32 %0, -70, !dbg !62
  %2 = icmp ugt i32 %.off, 129, !dbg !62
  %3 = icmp ugt i32 %1, 11
  %or.cond62 = select i1 %2, i1 true, i1 %3, !dbg !62
  br i1 %or.cond62, label %cleanup, label %if.end6, !dbg !62

if.end6:                                          ; preds = %entry
  %4 = trunc i64 %idxprom to i32
  %tm_mday = getelementptr inbounds %struct.tm, %struct.tm* %tm, i64 0, i32 3, !dbg !64
  %5 = load i32, i32* %tm_mday, align 4, !dbg !64, !tbaa !65
  call void @llvm.dbg.value(metadata i32 %5, metadata !37, metadata !DIExpression()), !dbg !50
  %cmp7 = icmp slt i32 %4, 2, !dbg !66
  %6 = and i32 %0, 3
  %tobool.not = icmp ne i32 %6, 0
  %or.cond = select i1 %cmp7, i1 true, i1 %tobool.not, !dbg !68
  %dec = sext i1 %or.cond to i32, !dbg !68
  call void @llvm.dbg.value(metadata i32 undef, metadata !37, metadata !DIExpression()), !dbg !50
  %tm_hour = getelementptr inbounds %struct.tm, %struct.tm* %tm, i64 0, i32 2, !dbg !69
  %7 = load i32, i32* %tm_hour, align 8, !dbg !69, !tbaa !71
  %cmp11 = icmp slt i32 %7, 0, !dbg !72
  br i1 %cmp11, label %cleanup, label %lor.lhs.false12, !dbg !73

lor.lhs.false12:                                  ; preds = %if.end6
  %tm_min = getelementptr inbounds %struct.tm, %struct.tm* %tm, i64 0, i32 1, !dbg !74
  %8 = load i32, i32* %tm_min, align 4, !dbg !74, !tbaa !75
  %conv32 = sext i32 %8 to i64, !dbg !76
  %cmp13 = icmp slt i32 %8, 0, !dbg !77
  br i1 %cmp13, label %cleanup, label %lor.lhs.false14, !dbg !78

lor.lhs.false14:                                  ; preds = %lor.lhs.false12
  %tm_sec63 = bitcast %struct.tm* %tm to i32*, !dbg !79
  %9 = load i32, i32* %tm_sec63, align 8, !dbg !79, !tbaa !80
  %conv35 = sext i32 %9 to i64, !dbg !81
  %cmp15 = icmp slt i32 %9, 0, !dbg !82
  br i1 %cmp15, label %cleanup, label %if.end17, !dbg !83

if.end17:                                         ; preds = %lor.lhs.false14
  %10 = mul i32 %0, 365, !dbg !84
  %mul = add i32 %10, -25550, !dbg !84
  %add18 = add nsw i32 %0, -69, !dbg !85
  %div = sdiv i32 %add18, 4, !dbg !86
  %add19 = add nsw i32 %mul, %div, !dbg !87
  %arrayidx = getelementptr inbounds [12 x i32], [12 x i32]* @tm_to_time_t.mdays, i64 0, i64 %idxprom, !dbg !61
  %11 = load i32, i32* %arrayidx, align 4, !dbg !61, !tbaa !88
  %add20 = add i32 %add19, %dec, !dbg !89
  %day.0 = add i32 %add20, %5, !dbg !68
  %add21 = add i32 %day.0, %11, !dbg !90
  %mul23 = mul i32 %add21, 1440, !dbg !91
  %conv = sext i32 %mul23 to i64, !dbg !92
  %mul24 = mul nsw i64 %conv, 60, !dbg !93
  %mul27 = mul i32 %7, 3600, !dbg !94
  %conv28 = sext i32 %mul27 to i64, !dbg !95
  %mul31 = mul nsw i64 %conv32, 60, !dbg !96
  %add29 = add nsw i64 %mul31, %conv28, !dbg !97
...
!3 = !DIFile(filename: "example.c", directory: "/Users/jryans/Projects/Malleable/Experiments/Debug Info/Issues/KLEE/git-tm-to-time-t")
...
!60 = !{!53, !54, i64 16}
!61 = !DILocation(line: 20, column: 40, scope: !2)
!62 = !DILocation(line: 12, column: 15, scope: !63)
!63 = distinct !DILexicalBlock(scope: !2, file: !3, line: 12, column: 6)
!64 = !DILocation(line: 10, column: 16, scope: !2)
!65 = !{!53, !54, i64 12}
!66 = !DILocation(line: 16, column: 12, scope: !67)
!67 = distinct !DILexicalBlock(scope: !2, file: !3, line: 16, column: 6)
!68 = !DILocation(line: 16, column: 16, scope: !67)
!69 = !DILocation(line: 18, column: 10, scope: !70)
!70 = distinct !DILexicalBlock(scope: !2, file: !3, line: 18, column: 6)
!71 = !{!53, !54, i64 8}
!72 = !DILocation(line: 18, column: 18, scope: !70)
!73 = !DILocation(line: 18, column: 22, scope: !70)
!74 = !DILocation(line: 18, column: 29, scope: !70)
!75 = !{!53, !54, i64 4}
!76 = !DILocation(line: 21, column: 25, scope: !2)
!77 = !DILocation(line: 18, column: 36, scope: !70)
!78 = !DILocation(line: 18, column: 40, scope: !70)
!79 = !DILocation(line: 18, column: 47, scope: !70)
!80 = !{!53, !54, i64 0}
!81 = !DILocation(line: 21, column: 43, scope: !2)
!82 = !DILocation(line: 18, column: 54, scope: !70)
!83 = !DILocation(line: 18, column: 6, scope: !2)
!84 = !DILocation(line: 20, column: 15, scope: !2)
!85 = !DILocation(line: 20, column: 29, scope: !2)
!86 = !DILocation(line: 20, column: 34, scope: !2)
!87 = !DILocation(line: 20, column: 21, scope: !2)
!88 = !{!54, !54, i64 0}
!89 = !DILocation(line: 20, column: 38, scope: !2)
!90 = !DILocation(line: 20, column: 53, scope: !2)
!91 = !DILocation(line: 20, column: 64, scope: !2)
!92 = !DILocation(line: 20, column: 9, scope: !2)
!93 = !DILocation(line: 20, column: 67, scope: !2)
!94 = !DILocation(line: 21, column: 19, scope: !2)
!95 = !DILocation(line: 21, column: 3, scope: !2)
!96 = !DILocation(line: 21, column: 36, scope: !2)

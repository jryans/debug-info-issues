...
echo "; \$(brew --prefix llvm)/bin/clang ${SRC_FILE} ${COMMON_OPTS} ${O1_OPTS} -mllvm -opt-bisect-limit=47 -o example-O1-partial-good.ll
" > example-O1-partial-good.ll
...
echo "; \$(brew --prefix llvm)/bin/clang ${SRC_FILE} ${COMMON_OPTS} ${O1_OPTS} -mllvm -opt-bisect-limit=48 -o example-O1-partial-bad.ll
" > example-O1-partial-bad.ll

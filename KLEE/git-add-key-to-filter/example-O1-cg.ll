...
entry:
  ...
  br i1 %cmp15.not, label %for.end, label %for.body.preheader, !dbg !69
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %2 = bitcast %struct.bloom_filter* %filter to i8**
  %3 = bitcast %struct.bloom_key* %key to i32**
  call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !45, metadata !DIExpression()), !dbg !55
  %4 = load i32*, i32** %3, align 8, !dbg !70, !tbaa !71
  %scevgep = getelementptr i32, i32* %4, i64 %indvars.iv, !dbg !73
  %5 = load i32, i32* %scevgep, align 4, !dbg !73, !tbaa !74
  %conv = zext i32 %5 to i64, !dbg !73
  ...
  %6 = load i8*, i8** %2, align 8, !dbg !80, !tbaa !81
  %arrayidx3 = getelementptr inbounds i8, i8* %6, i64 %div, !dbg !82
  %7 = load i8, i8* %arrayidx3, align 1, !dbg !83, !tbaa !84
  %or14 = or i8 %7, %call, !dbg !83
  ...
  %8 = bitcast %struct.bloom_filter_settings* %settings to i8*, !dbg !64
  %sunkaddr = getelementptr inbounds i8, i8* %8, i64 4, !dbg !64
  %9 = bitcast i8* %sunkaddr to i32*, !dbg !64
  %10 = load i32, i32* %9, align 4, !dbg !64, !tbaa !65
  %11 = zext i32 %10 to i64, !dbg !68
  %cmp = icmp ult i64 %indvars.iv.next, %11, !dbg !68
...
!12 = distinct !DISubprogram(name: "add_key_to_filter", scope: !1, file: !1, line: 53, type: !13, scopeLine: 54, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !41)
...
!42 = !DILocalVariable(name: "key", arg: 1, scope: !12, file: !1, line: 53, type: !15)
!43 = !DILocalVariable(name: "filter", arg: 2, scope: !12, file: !1, line: 53, type: !24)
!44 = !DILocalVariable(name: "settings", arg: 3, scope: !12, file: !1, line: 54, type: !33)
!45 = !DILocalVariable(name: "i", scope: !12, file: !1, line: 55, type: !46)
!46 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!47 = !DILocalVariable(name: "mod", scope: !12, file: !1, line: 56, type: !48)
...
!50 = !DILocalVariable(name: "hash_mod", scope: !51, file: !1, line: 59, type: !48)
!51 = distinct !DILexicalBlock(scope: !52, file: !1, line: 58, column: 46)
!52 = distinct !DILexicalBlock(scope: !53, file: !1, line: 58, column: 3)
!53 = distinct !DILexicalBlock(scope: !12, file: !1, line: 58, column: 3)
!54 = !DILocalVariable(name: "block_pos", scope: !51, file: !1, line: 60, type: !48)
!55 = !DILocation(line: 0, scope: !12)
!56 = !DILocation(line: 56, column: 26, scope: !12)
!57 = !{!58, !62, i64 8}
...
!61 = !{!"Simple C/C++ TBAA"}
!62 = !{!"long", !60, i64 0}
!63 = !DILocation(line: 56, column: 30, scope: !12)
!64 = !DILocation(line: 58, column: 29, scope: !52)
!65 = !{!66, !67, i64 4}
!66 = !{!"bloom_filter_settings", !67, i64 0, !67, i64 4, !67, i64 8, !67, i64 12}
!67 = !{!"int", !60, i64 0}
!68 = !DILocation(line: 58, column: 17, scope: !52)
!69 = !DILocation(line: 58, column: 3, scope: !53)
!70 = !DILocation(line: 59, column: 30, scope: !51)
!71 = !{!72, !59, i64 0}
!72 = !{!"bloom_key", !59, i64 0}
!73 = !DILocation(line: 59, column: 25, scope: !51)
!74 = !{!67, !67, i64 0}
!75 = !DILocation(line: 59, column: 40, scope: !51)
!76 = !DILocation(line: 0, scope: !51)
!77 = !DILocation(line: 60, column: 35, scope: !51)
!78 = !DILocation(line: 62, column: 44, scope: !51)
!79 = !DILocation(line: 62, column: 32, scope: !51)
!80 = !DILocation(line: 62, column: 13, scope: !51)
!81 = !{!58, !59, i64 0}
!82 = !DILocation(line: 62, column: 5, scope: !51)
!83 = !DILocation(line: 62, column: 29, scope: !51)
!84 = !{!60, !60, i64 0}
!85 = !DILocation(line: 58, column: 42, scope: !52)
!86 = distinct !{!86, !69, !87, !88, !89}
!87 = !DILocation(line: 63, column: 3, scope: !53)
!88 = !{!"llvm.loop.mustprogress"}
!89 = !{!"llvm.loop.unroll.disable"}
!90 = !DILocation(line: 64, column: 1, scope: !12)
!91 = distinct !DISubprogram(name: "get_bitmask", scope: !1, file: !1, line: 49, type: !92, scopeLine: 49, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !94)
...
!101 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 70, type: !102, scopeLine: 70, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !104)
!102 = !DISubroutineType(types: !103)
!103 = !{!46}
!104 = !{!105, !106, !107}
!105 = !DILocalVariable(name: "key", scope: !101, file: !1, line: 78, type: !17)
!106 = !DILocalVariable(name: "filter", scope: !101, file: !1, line: 79, type: !25)
!107 = !DILocalVariable(name: "settings", scope: !101, file: !1, line: 80, type: !35)
!108 = !DILocation(line: 78, column: 3, scope: !101)
!109 = !DILocation(line: 78, column: 20, scope: !101)
!110 = !DILocation(line: 79, column: 3, scope: !101)
!111 = !DILocation(line: 79, column: 23, scope: !101)
!112 = !DILocation(line: 80, column: 3, scope: !101)
!113 = !DILocation(line: 80, column: 32, scope: !101)
!114 = !DILocation(line: 81, column: 3, scope: !101)
!115 = !DILocation(line: 82, column: 3, scope: !101)
!116 = !DILocation(line: 83, column: 3, scope: !101)
!117 = !DILocation(line: 86, column: 3, scope: !101)
!118 = !DILocation(line: 87, column: 1, scope: !101)

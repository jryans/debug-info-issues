...
entry:
  ...
  call void @llvm.dbg.value(metadata i64* %n, metadata !38, metadata !DIExpression(DW_OP_deref)), !dbg !41
  call void @klee_make_symbolic(i8* nonnull %0, i64 8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #6, !dbg !42
  %1 = load i64, i64* %n, align 8, !dbg !43, !tbaa !27
  call void @llvm.dbg.value(metadata i64 %1, metadata !38, metadata !DIExpression()), !dbg !41
  %call = call i64 @example(i64 %1), !dbg !44
  call void @llvm.dbg.value(metadata i64 %call, metadata !39, metadata !DIExpression()), !dbg !41
  %conv = trunc i64 %call to i32, !dbg !45
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %0) #6, !dbg !46
  ret i32 %conv, !dbg !47
}

declare !dbg !48 void @klee_make_symbolic(i8*, i64, i8*) local_unnamed_addr #4
...
!20 = !DILocalVariable(name: "i", scope: !10, file: !1, line: 3, type: !13)
!21 = !DILocation(line: 0, scope: !10)
!22 = !DILocation(line: 2, column: 17, scope: !10)
...
!26 = !DILocation(line: 9, column: 10, scope: !10)
!27 = !{!28, !28, i64 0}
!28 = !{!"long", !29, i64 0}
!29 = !{!"omnipotent char", !30, i64 0}
!30 = !{!"Simple C/C++ TBAA"}
!31 = !DILocation(line: 9, column: 3, scope: !10)
!32 = distinct !DISubprogram(name: "main", scope: !33, file: !33, line: 3, type: !34, scopeLine: 3, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !37)
!33 = !DIFile(filename: "./../main.h", directory: "/Users/jryans/Projects/Malleable/Experiments/Debug Info/Issues/KLEE/branch-array-select")
!34 = !DISubroutineType(types: !35)
!35 = !{!36}
!36 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!37 = !{!38, !39}
!38 = !DILocalVariable(name: "n", scope: !32, file: !33, line: 4, type: !13)
!39 = !DILocalVariable(name: "result", scope: !32, file: !33, line: 6, type: !13)
!40 = !DILocation(line: 4, column: 3, scope: !32)
!41 = !DILocation(line: 0, scope: !32)
!42 = !DILocation(line: 5, column: 3, scope: !32)
!43 = !DILocation(line: 6, column: 34, scope: !32)
!44 = !DILocation(line: 6, column: 26, scope: !32)
!45 = !DILocation(line: 7, column: 10, scope: !32)
!46 = !DILocation(line: 8, column: 1, scope: !32)
!47 = !DILocation(line: 7, column: 3, scope: !32)
!48 = !DISubprogram(name: "klee_make_symbolic", scope: !49, file: !49, line: 37, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !2)

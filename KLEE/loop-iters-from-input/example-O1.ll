; $(brew --prefix llvm)/bin/clang example.c -I /Users/jryans/Projects/klee/include -g -fno-inline -fno-discard-value-names -c -S -emit-llvm -O1 -o example-O1.ll
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #5, !dbg !34
  call void @llvm.dbg.value(metadata i32* %n, metadata !32, metadata !DIExpression(DW_OP_deref)), !dbg !35
  call void @klee_make_symbolic(i8* nonnull %0, i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #5, !dbg !36
  %1 = load i32, i32* %n, align 4, !dbg !37, !tbaa !38
  call void @llvm.dbg.value(metadata i32 %1, metadata !32, metadata !DIExpression()), !dbg !35
  %call = call i32 @example(i32 %1), !dbg !42
  call void @llvm.dbg.value(metadata i32 %call, metadata !33, metadata !DIExpression()), !dbg !35
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #5, !dbg !43
  ret i32 %call, !dbg !44
}

declare !dbg !45 void @klee_make_symbolic(i8*, i64, i8*) local_unnamed_addr #3
...
!23 = !DILocation(line: 6, column: 30, scope: !24)
!24 = distinct !DILexicalBlock(scope: !19, file: !1, line: 6, column: 3)
!25 = !DILocation(line: 6, column: 3, scope: !19)
!26 = !DILocation(line: 4, column: 13, scope: !10)
!27 = !DILocation(line: 9, column: 3, scope: !10)
!28 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 12, type: !29, scopeLine: 12, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !31)
!29 = !DISubroutineType(types: !30)
!30 = !{!13}
!31 = !{!32, !33}
!32 = !DILocalVariable(name: "n", scope: !28, file: !1, line: 13, type: !13)
!33 = !DILocalVariable(name: "result", scope: !28, file: !1, line: 15, type: !13)
!34 = !DILocation(line: 13, column: 3, scope: !28)
!35 = !DILocation(line: 0, scope: !28)
!36 = !DILocation(line: 14, column: 3, scope: !28)
!37 = !DILocation(line: 15, column: 24, scope: !28)
!38 = !{!39, !39, i64 0}
!39 = !{!"int", !40, i64 0}
!40 = !{!"omnipotent char", !41, i64 0}
!41 = !{!"Simple C/C++ TBAA"}
!42 = !DILocation(line: 15, column: 16, scope: !28)
!43 = !DILocation(line: 17, column: 1, scope: !28)
!44 = !DILocation(line: 16, column: 3, scope: !28)
!45 = !DISubprogram(name: "klee_make_symbolic", scope: !46, file: !46, line: 37, type: !47, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !2)
!46 = !DIFile(filename: "klee/include/klee/klee.h", directory: "/Users/jryans/Projects")

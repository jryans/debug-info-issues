...
if.end:                                           ; preds = %if.else, %if.then
  %a.0 = phi i32 [ %n, %if.then ], [ %add, %if.else ], !dbg !27
  %b.0 = phi i32 [ 1, %if.then ], [ 2, %if.else ], !dbg !27
  call void @llvm.dbg.value(metadata i32 %b.0, metadata !18, metadata !DIExpression()), !dbg !19
  call void @llvm.dbg.value(metadata i32 %a.0, metadata !17, metadata !DIExpression()), !dbg !19
  %add1 = add nsw i32 %n, %a.0, !dbg !28
  %add2 = add nsw i32 %add1, 1, !dbg !29
  %add3 = add nsw i32 %b.0, %add2, !dbg !30
  call void @llvm.dbg.value(metadata i32 %add3, metadata !18, metadata !DIExpression()), !dbg !19
  %add4 = add nsw i32 %a.0, %add3, !dbg !31
  ret i32 %add4, !dbg !32
}
...
!18 = !DILocalVariable(name: "b", scope: !11, file: !8, line: 3, type: !14)
...
!25 = !DILocation(line: 9, column: 11, scope: !26)
!26 = distinct !DILexicalBlock(scope: !21, file: !8, line: 7, column: 10)
!27 = !DILocation(line: 0, scope: !21)
!28 = !DILocation(line: 11, column: 10, scope: !11)
!29 = !DILocation(line: 11, column: 14, scope: !11)
!30 = !DILocation(line: 11, column: 5, scope: !11)
!31 = !DILocation(line: 12, column: 12, scope: !11)

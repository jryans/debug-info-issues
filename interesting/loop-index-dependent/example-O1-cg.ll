...
for.body:                                         ; preds = %entry, %for.inc
  ...
  call void @llvm.dbg.value(metadata i32 %lsr.iv, metadata !18, metadata !DIExpression(DW_OP_consts, 1, DW_OP_minus, DW_OP_consts, 18446744073709551615, DW_OP_div, DW_OP_stack_value)), !dbg !21
  call void @llvm.dbg.value(metadata i32 %r.07, metadata !17, metadata !DIExpression()), !dbg !20
  %tobool.not = icmp eq i32 %lsr.iv, 1, !dbg !24
...
for.inc:                                          ; preds = %if.then, %if.else
  ...
  call void @llvm.dbg.value(metadata i32 %lsr.iv, metadata !18, metadata !DIExpression(DW_OP_consts, 1, DW_OP_minus, DW_OP_consts, 18446744073709551615, DW_OP_div, DW_OP_consts, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !21
  %lsr.iv.next = add nsw i32 %lsr.iv, -1, !dbg !33
  %cmp = icmp eq i32 %lsr.iv.next, 0, !dbg !33
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !dbg !22, !llvm.loop !34
}

declare !dbg !38 i32 @modify(i32) local_unnamed_addr #1
...
!33 = !DILocation(line: 5, column: 21, scope: !27)
!34 = distinct !{!34, !22, !35, !36, !37}
!35 = !DILocation(line: 10, column: 3, scope: !19)
!36 = !{!"llvm.loop.mustprogress"}
!37 = !{!"llvm.loop.unroll.disable"}
!38 = !DISubprogram(name: "modify", scope: !8, file: !8, line: 1, type: !12, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !9)

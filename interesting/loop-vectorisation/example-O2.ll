...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %0 = getelementptr inbounds i32, i32* %x, i64 %index, !dbg !27
  %1 = bitcast i32* %0 to <4 x i32>*, !dbg !28
  %wide.load = load <4 x i32>, <4 x i32>* %1, align 4, !dbg !28, !tbaa !30
  %2 = add <4 x i32> %wide.load, %vec.phi, !dbg !34
  %index.next = add nuw i64 %index, 4, !dbg !27
  %3 = icmp eq i64 %index.next, %n.vec, !dbg !27
  br i1 %3, label %middle.block, label %vector.body, !dbg !27, !llvm.loop !35

middle.block:                                     ; preds = %vector.body
  %4 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %2), !dbg !26
...
for.cond.cleanup:                                 ; preds = %for.body, %middle.block, %entry
  %r.0.lcssa = phi i32 [ 0, %entry ], [ %4, %middle.block ], [ %add, %for.body ], !dbg !22
...
for.body:                                         ; preds = %for.body.preheader9, %for.body
  ...
  %arrayidx = getelementptr inbounds i32, i32* %x, i64 %indvars.iv, !dbg !28
  %5 = load i32, i32* %arrayidx, align 4, !dbg !28, !tbaa !30
  %add = add nsw i32 %5, %r.07, !dbg !34

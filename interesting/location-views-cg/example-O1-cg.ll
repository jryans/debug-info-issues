...
define i32 @example(i32 %a, i32 %b, i32 %c, i32 %d) local_unnamed_addr #0 !dbg !11 {
entry:
  call void @llvm.dbg.value(metadata i32 %a, metadata !16, metadata !DIExpression()), !dbg !22
  call void @llvm.dbg.value(metadata i32 %b, metadata !17, metadata !DIExpression()), !dbg !22
  call void @llvm.dbg.value(metadata i32 %c, metadata !18, metadata !DIExpression()), !dbg !22
  call void @llvm.dbg.value(metadata i32 %d, metadata !19, metadata !DIExpression()), !dbg !22
  %add = add nsw i32 %b, %a, !dbg !23
  call void @llvm.dbg.value(metadata i32 %add, metadata !20, metadata !DIExpression()), !dbg !22
  %mul = mul nsw i32 %d, %c, !dbg !24
  call void @llvm.dbg.value(metadata i32 %mul, metadata !21, metadata !DIExpression()), !dbg !22
  %sub = sub i32 %add, %mul, !dbg !25
  call void @llvm.dbg.value(metadata i32 %sub, metadata !20, metadata !DIExpression()), !dbg !22
  %add1 = shl nsw i32 %mul, 1, !dbg !26
  call void @llvm.dbg.value(metadata i32 %add1, metadata !21, metadata !DIExpression()), !dbg !22
  %add2 = add nsw i32 %sub, %add1, !dbg !27
  ret i32 %add2, !dbg !28
}
...
!16 = !DILocalVariable(name: "a", arg: 1, scope: !11, file: !8, line: 1, type: !14)
!17 = !DILocalVariable(name: "b", arg: 2, scope: !11, file: !8, line: 1, type: !14)
!18 = !DILocalVariable(name: "c", arg: 3, scope: !11, file: !8, line: 1, type: !14)
!19 = !DILocalVariable(name: "d", arg: 4, scope: !11, file: !8, line: 1, type: !14)
!20 = !DILocalVariable(name: "x", scope: !11, file: !8, line: 2, type: !14)
...
!26 = !DILocation(line: 5, column: 5, scope: !11)
!27 = !DILocation(line: 6, column: 12, scope: !11)

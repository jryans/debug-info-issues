...
entry:
  ...
  br i1 %cmp15.not, label %for.end, label %for.body.preheader, !dbg !71
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %4 = load i32*, i32** %3, align 8, !dbg !72, !tbaa !73
  %scevgep = getelementptr i32, i32* %4, i64 %indvars.iv, !dbg !75
  %5 = load i32, i32* %scevgep, align 4, !dbg !75, !tbaa !76
  %conv = zext i32 %5 to i64, !dbg !75
  ...
  %6 = load i8*, i8** %2, align 8, !dbg !82, !tbaa !83
  %arrayidx3 = getelementptr inbounds i8, i8* %6, i64 %div, !dbg !84
  %7 = load i8, i8* %arrayidx3, align 1, !dbg !85, !tbaa !86
  %or14 = or i8 %7, %call, !dbg !85
  ...
  %8 = bitcast %struct.bloom_filter_settings* %settings to i8*, !dbg !66
  %sunkaddr = getelementptr inbounds i8, i8* %8, i64 4, !dbg !66
  %9 = bitcast i8* %sunkaddr to i32*, !dbg !66
  %10 = load i32, i32* %9, align 4, !dbg !66, !tbaa !67
  %11 = zext i32 %10 to i64, !dbg !70
  %cmp = icmp ult i64 %indvars.iv.next, %11, !dbg !70

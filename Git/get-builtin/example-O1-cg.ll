...
for.cond:                                         ; preds = %for.body
  call void @llvm.dbg.value(metadata i64 %lsr.iv, metadata !37, metadata !DIExpression(DW_OP_consts, 24, DW_OP_div, DW_OP_consts, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !42
  call void @llvm.dbg.value(metadata i64 %lsr.iv, metadata !37, metadata !DIExpression(DW_OP_consts, 24, DW_OP_div, DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !42
  %lsr.iv.next = add nuw nsw i64 %lsr.iv, 24, !dbg !44
  %exitcond.not = icmp eq i64 %lsr.iv.next, 96, !dbg !44
  br i1 %exitcond.not, label %cleanup1, label %for.body, !dbg !43, !llvm.loop !45

for.body:                                         ; preds = %entry, %for.cond
  %lsr.iv = phi i64 [ 0, %entry ], [ %lsr.iv.next, %for.cond ]
  %retval.08 = phi %struct.cmd_struct* [ undef, %entry ], [ %add.ptr.retval.0, %for.cond ]
  call void @llvm.dbg.value(metadata i64 %lsr.iv, metadata !37, metadata !DIExpression(DW_OP_consts, 24, DW_OP_div, DW_OP_stack_value)), !dbg !42
  call void @llvm.dbg.value(metadata !DIArgList(i64 %lsr.iv, [4 x %struct.cmd_struct]* @commands), metadata !38, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_consts, 24, DW_OP_div, DW_OP_consts, 24, DW_OP_mul, DW_OP_LLVM_arg, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !49
  %uglygep = getelementptr i8, i8* bitcast ([4 x %struct.cmd_struct]* @commands to i8*), i64 %lsr.iv, !dbg !50
  %uglygep9 = bitcast i8* %uglygep to %struct.cmd_struct*, !dbg !50
  %uglygep10 = bitcast i8* %uglygep to i8**, !dbg !50
  %0 = load i8*, i8** %uglygep10, align 8, !dbg !50, !tbaa !52
  %call = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %s, i8* noundef nonnull dereferenceable(1) %0), !dbg !58
  %tobool.not = icmp eq i32 %call, 0, !dbg !58
  %add.ptr.retval.0 = select i1 %tobool.not, %struct.cmd_struct* %uglygep9, %struct.cmd_struct* %retval.08, !dbg !59
  call void @llvm.dbg.value(metadata i64 %lsr.iv, metadata !37, metadata !DIExpression(DW_OP_consts, 24, DW_OP_div, DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !42
...
cleanup1:                                         ; preds = %for.cond, %for.body
  ...
  ret %struct.cmd_struct* %retval.2, !dbg !60
}
...
!44 = !DILocation(line: 19, column: 17, scope: !40)
!45 = distinct !{!45, !43, !46, !47, !48}
!46 = !DILocation(line: 23, column: 3, scope: !41)
!47 = !{!"llvm.loop.mustprogress"}
!48 = !{!"llvm.loop.unroll.disable"}
!49 = !DILocation(line: 0, scope: !39)
!50 = !DILocation(line: 21, column: 23, scope: !51)
!51 = distinct !DILexicalBlock(scope: !39, file: !3, line: 21, column: 9)
!52 = !{!53, !54, i64 0}
!53 = !{!"cmd_struct", !54, i64 0, !54, i64 8, !57, i64 16}
!54 = !{!"any pointer", !55, i64 0}
!55 = !{!"omnipotent char", !56, i64 0}
!56 = !{!"Simple C/C++ TBAA"}
!57 = !{!"int", !55, i64 0}
!58 = !DILocation(line: 21, column: 10, scope: !51)
!59 = !DILocation(line: 0, scope: !40)
!60 = !DILocation(line: 25, column: 1, scope: !31)
